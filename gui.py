...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(419, 454)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("../leap/PCRecognizer_LEAP/background.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.button_download.setGeometry(QtCore.QRect(30, 210, 111, 23))
        self.button_download.setObjectName(_fromUtf8("button_download"))
        self.line = QtGui.QFrame(self.centralwidget)
        self.line.setGeometry(QtCore.QRect(30, 190, 351, 16))
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName(_fromUtf8("line"))
        self.progressbar = QtGui.QProgressBar(self.centralwidget)
        self.progressbar.setGeometry(QtCore.QRect(260, 210, 121, 23))
        font = QtGui.QFont()
        ...
        self.button_search.setGeometry(QtCore.QRect(310, 160, 75, 23))
        ...
        self.textEdit_folder.setGeometry(QtCore.QRect(30, 160, 261, 21))
        ...
        self.textEdit_logs.setGeometry(QtCore.QRect(30, 250, 351, 161))
